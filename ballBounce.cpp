...
Bounce( float dt )
{
	...
	while( dt > EPSILON )
	{
		...
		float tfloor1 = (-Vynow + sqrt((Vynow * Vynow) - (4 * 0.5 * Gravity * (Ynow - YBOTTOM - RADIUS)))) / Gravity;
		...
		float tfloor2 = (-Vynow - sqrt((Vynow * Vynow) - (4 * 0.5 * Gravity * (Ynow - YBOTTOM - RADIUS)))) / Gravity;	// time to hit the floor (note there are 2 answers)
