...
InitGraphics( void )
{
	...
	Xpos.AddTimeValue(    0.f,    500.f );
	Xpos.AddTimeValue(4.f, 700.f);
	Xpos.AddTimeValue(8.f, 50.f);
	Xpos.AddTimeValue(10.f, 500.f);

	Ypos.AddTimeValue(0.f, 500.f);
	Ypos.AddTimeValue(   2.f, 1000.f);
	Ypos.AddTimeValue(   4.f,  50.f );
	Ypos.AddTimeValue(6.f, 700.f);
	Ypos.AddTimeValue(8.f, 50.f);
	Ypos.AddTimeValue(10.f, 500.f);

	Zpos.AddTimeValue(0.f, 500.f);
	Zpos.AddTimeValue(4.f, 1000.f);
	Zpos.AddTimeValue(8.f, 50.f);
	Zpos.AddTimeValue(10.f, 500.f);

	ThetaX.AddTimeValue(0.f, 500.f);
	ThetaX.AddTimeValue(4.f, 700.f);
	ThetaX.AddTimeValue(8.f, 50.f);
	ThetaX.AddTimeValue(10.f, 500.f);

	//ThetaY.AddTimeValue(0.f, 500.f);
	//ThetaY.AddTimeValue(4.f, 700.f);
	//ThetaY.AddTimeValue(8.f, 50.f);
}
...
InitLists( void )
{
	...
	{
		float xpos = Xpos.GetValue(9.);
		float ypos = Ypos.GetValue(9.);
		float zpos = Zpos.GetValue(9.);
		float ax = ThetaX.GetValue(9.);
		float ay = ThetaY.GetValue(9.);
		float az = ThetaZ.GetValue(9.);
		glPushMatrix();
			glTranslatef(xpos, ypos, zpos);
			glRotatef(ax, 1., 0., 0.);
			glRotatef(ay, 0., 1., 0.);
	...
	{
		float xpos = Xpos.GetValue(8.);
		float ypos = Ypos.GetValue(8.);
		float zpos = Zpos.GetValue(8.);
		float ax = ThetaX.GetValue(8.);
		float ay = ThetaY.GetValue(8.);
		float az = ThetaZ.GetValue(8.);
		glPushMatrix();
			glTranslatef(xpos, ypos, zpos);
			glRotatef(ax, 1., 0., 0.);
			glRotatef(ay, 0., 1., 0.);
	...
	{
		float xpos = Xpos.GetValue(6.);
		float ypos = Ypos.GetValue(6.);
		float zpos = Zpos.GetValue(6.);
		float ax = ThetaX.GetValue(6.);
		float ay = ThetaY.GetValue(6.);
		float az = ThetaZ.GetValue(6.);
		glPushMatrix();
			glTranslatef(xpos, ypos, zpos);
			glRotatef(ax, 1., 0., 0.);
			glRotatef(ay, 0., 1., 0.);
	...
	{
		float xpos = Xpos.GetValue(4.);
		float ypos = Ypos.GetValue(4.);
		float zpos = Zpos.GetValue(4.);
		float ax = ThetaX.GetValue(4.);
		float ay = ThetaY.GetValue(4.);
		float az = ThetaZ.GetValue(4.);
		glPushMatrix();
			glTranslatef(xpos, ypos, zpos);
			glRotatef(ax, 1., 0., 0.);
			glRotatef(ay, 0., 1., 0.);
